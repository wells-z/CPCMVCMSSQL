...
namespace CoolPrivilegeControl.Areas.HRModule.Controllers
{
    ...
    [ExportMetadata("ControllerName", "SalaryReview")]
    [ExportMetadata("Order", 1)]
    public class SalaryReviewController : CommonController, IController
    {
        ...
        public SalaryReviewController(CompositionContainer container)
        {
