...
namespace CoolPrivilegeControl.Areas.HRModule.Controllers
{
    ...
    [ExportMetadata("ControllerName", "StaffInfoManage")]
    [ExportMetadata("Order", 1)]
    public class StaffInfoManageController : CommonController, IController
    {
        ...
        public StaffInfoManageController(CompositionContainer container)
        {
