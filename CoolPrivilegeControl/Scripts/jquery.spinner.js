...
; (function ($) {
    ...
    Spinning.rules = {
        ...
        quantity: { min: -99999999, max: 99999999, step: 1, precision: 0 },
    ...
    Spinning.prototype = {
        ...
        value: function (v) {
            ...
            this.$el.val(Math.round(v * Math.pow(10, this.options.precision)) / Math.pow(10, this.options.precision));
        ...
        numeric: function (v) {
            //var MinimumValue = this.$el.attr("minimum");
            //var MaxmumValue = this.$el.attr("maximum");

            //if (MinimumValue != undefined && MinimumValue != "") {
            //    this.options.min = MinimumValue
            //}

            //if (MaxmumValue != undefined && MaxmumValue != "") {
            //    this.options.max = MaxmumValue
            //}
